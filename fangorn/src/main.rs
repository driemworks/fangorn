...
async fn main() -> Result<()> {
    ...
    match &args.command {
        ...
        Some(Commands::Run {
            ...
            let vault_config = VaultConfig{vault_dir: vault_dir.clone(), substrate_name: substrate_name.clone(), vault_pswd: vault_pswd.clone(), iroh_key_pswd: iroh_key_pswd.clone(), ste_key_pswd: ste_key_pswd.clone(), substrate_pswd: substrate_pswd.clone()};
            // start the service
